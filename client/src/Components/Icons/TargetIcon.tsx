    ...
    <IconSvg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 733.03 734.39">
      ...
      <g id="Layer_2" data-name="Layer 2">
        <g id="Layer_1-2" data-name="Layer 1">
          <path
            className="cls-1"
            d="M475,349.08a138.31,138.31,0,0,1,6.35,41.42c0,76.82-62.49,139.32-139.31,139.32S202.67,467.32,202.67,390.5,265.17,251.18,342,251.18A138.74,138.74,0,0,1,390.76,260l46.7-46.69A203.76,203.76,0,0,0,340,188.63c-113.08,0-205.07,92-205.07,205.07s92,205.07,205.07,205.07,205.07-92,205.07-205.07a203.59,203.59,0,0,0-22.18-92.56Z"
          />
          <path
            className="cls-1"
            d="M342.33,325c-.78,0-1.56,0-2.34,0a68.3,68.3,0,1,0,2.34,0Z"
          />
          <path
            className="cls-1"
