...
const StartIcon : React.FC = () => {
    return (
        <IconSvg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 width="284.936px" height="284.936px" viewBox="0 0 284.936 284.936" style={{enableBackground:"new 0 0 284.936 284.936"} as React.CSSProperties}
	 xmlSpace="preserve">
        <g>
            <g>
